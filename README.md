...
Прошивка достаточно гибкая. В файле include/defines.h и include/defines_esp32.h или include/defines_esp32с3.h, в зависимости от исспользуемого микроконтроллера, надо определить какие пины выделить на насосы, какие на датчики влажности, какой тип реле LOW или HIGH применён и сколько Вы хотите ячеек для расписания полива. Всё. Дальше вэб будет отображать именно Ваше количество насосов, датчиков, пунктов расписания. Файлики маленькие и надеюсь достаточно хорошо откомментированы.
...
Из особенностей esp32 и esp32c3 могу указать, что в esp32 сенсорную кнопку надо располагать обязательно на adc2, иначе он кофликтует с adc1 на который желательно располагать датчики влажности. Датчики влажности нельзя располагать на adc2, так будет конфликт с wifi. У esp32c3 нет сенсорных входов, нужна обычная механическая кнопка или внешняя сенсорная типа TTP223B. Так-же надо помнить, что ножка GPIO8 в esp32c3 используется и для I2C и для onboard LED.
