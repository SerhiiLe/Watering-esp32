...
4) перепад высоты между насосом и концом трубки должен быть как можно меньше. Если поднимать воду на большую высоту, то это приводит к повышенному износу насоса и выходу его из строя.
5) более тонкая трубка создаёт меньше нагрузку на насосы и позволяет поднимать воду на большую высоту. Кроме того она более гибкая и это позволяет легче укладывать её, не мешая насосу.
6) цена вопроса определяется не стоимостью микроконтроллера, датчиков и насосов. А стоимостью шланга и проводов. Их надо много и в сумме они дороже электроники.
7) если цветов много, то длина шлангов и проводов должна быть разной, в зависимости от удаленности от емкости с водой.
8) в начале я купил реле для подключения насосов. Но они оказались настолько большими, тяжелыми и неудобными для подключения, что в итоге я использовал схему на полевых транзисторах. И в большинстве схем авторы пошли тем-же путём.
9) привлекает идея питать всё автономно, от аккумулятора. Но ток в момент старта насоса примерно 360мА, а во время работы 160мА. И это не включая потребления датчиков и самого микроконтроллера, даже если он будет большую часть времени спать. Кроме того, от 3.7В насосы работают совсем не резво. Ставить повышающий преобразователь - получить ещё больше потери емкости. И того, или надо собирать батарею приличной емкости, или не выпендриваться и работать от сети 230В. К стати, а как заряжать аккумуляторы? Бегать к ним с зарядкой? Впрочем один интересный по исполнению проект я нашел и автор утверждает, что он автономен 3 месяца...
10) датчик влажности надо брать емкостной, иначе он просто растворится за пару месяцев. Тоже касается и датчика уровня воды. В некоторых проектах применено интересное решение, при котором питание датчиков не постоянно, а только на момент опроса. Это требует дополнительных ног, что немного усложняет проект, тем не менее решение интересное и рабочее. Я же просто использовал емкостной датчик и вообще не ставил датчик уровня воды в баке.
11) топить насос или не топить? По правильному - топить. Но я, скептически посмотрев на качество герметизации решил не топить, пусть плавает в полу погруженном состоянии. Просто взял два куска пенопласта и стянул стяжками, а между ними зажались насосы. Шланги должны проходить так, чтобы не образовывались воздушные пробки.
12) показания аналоговых датчиков скачет как кардиограмма, что может приводить к неожиданному включению полива или наоборот к не включению. По этому нужен хотя-бы простейший фильтр показаний.
13) нет никакого общего правила как будет реагировать земля на полив и сколько надо поливать. В зависимости от грунта влажность может резко подскочить после полива или наоборот медленно подниматься. А у цветов в зависимости от времени года и температуры меняется потребность в воде. Хорошей практикой может быть небольшой полив утром, а в течении дня поддержание влажности на нужном уровне маленькими порциями. Если понадобится. Если влажность начала расти, надо уменьшить порцию утреннего полива.
14) застойная вода в открытом сосуде имеет свойство "цвести". Это нормально, в воздухе всегда летают споры одноклеточных водорослей. По этому вся эта конструкция требует или регулярной чистки или должна работать только относительно короткий период отпуска/командировки. Увы. Уменьшить скорость цветения можно закрыв ёмкость с водой от солнца и прикрыв крышкой.
15) насосы могут ржаветь или забиваться водорослями или "накипью". Для хранения насосы надо обязательно высушить, а после хранения убедится, что ничего не заклинило и работает.
