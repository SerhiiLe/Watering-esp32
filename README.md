...
Machine for watering several flowers. Autonomous, but with a WEB interface and sending messages to Telegram. Based on a esp32 family microcontrollers.No AI code.
...
Является полигоном для разных технологий, которые обычно в простые поливалки не засовывают и без них тоже работает. Но скучно. "Нам скучно, нам движуха нужна" © Старый Маразматик. В дальнейшем эти технологии уходят в другие проекты. По этому структура относительно модульная.

## Зачем это вообще нужно?

Каждый человек, который решил попробовать что такое паяльник и электроника должен пройти несколько этапов.

1) собрать моргалку светодиодом blink. Можно с помощью микроконтроллера, но это не путь истинного Джедая, лучше на транзисторах или, на худой конец, на NE555.
...
Есть как минимум два варианта поиска на github. По тегу watering и по тегу polivalka. По второму, к слову, больше толковых проектов.

Я пересмотрел почти все, на что потратил пол дня, и вот какие варианты существуют.

1) пустой проект. Иногда с readme или даже презентацией: "мы всем классом подумали и решили, что поливалка это круто!" Таких примерно четверть!
...
- чтобы вода не вытекла сразу после первого включения насоса, нужно использовать или мембранный насос (но обычно они намного дороже и имеют питание 12В), или располагать емкость на другом уровне относительно цветка. Если это насос, то он должен быть ниже уровня цветов. Если это управляемый клапан, то наоборот выше уровня цветов. К стати, в случае с управляемым запорным клапаном можно подключится к водопроводу. Но этот риск на любителя.
- трубка к насосу должна подходить по размеру. К примеру я взял первое попавшееся - 6/4мм. А носик насоса 7мм. Думаю понятно, что я устраивал садистские действия со шлангом, чтобы превратить 4мм внутреннего диаметра в 7мм. Хорошо, что он выдержал. Авторы которые рекомендуют 6/4 садисты которые сами попались на это и хотят, чтобы другие тоже мучились. С учётом цены на трубку ошибка может быть болезненной. [У меня такой насос.](https://ledplus.com.ua/ua/p1160030538-vodyanoj-nasos-pompa.html)
- перепад высоты между насосом и концом трубки должен быть как можно меньше. Если поднимать воду на большую высоту, то это приводит к повышенному износу насоса и выходу его из строя.
- более тонкая трубка создаёт меньше нагрузку на насосы и позволяет поднимать воду на большую высоту. Кроме того она более гибкая и это позволяет легче укладывать её, не мешая насосу.
- цена вопроса определяется не стоимостью микроконтроллера, датчиков и насосов. А стоимостью шланга и проводов. Их надо много и в сумме они дороже электроники.
- если цветов много, то длина шлангов и проводов должна быть разной, в зависимости от удаленности от емкости с водой.
- в начале я купил реле для подключения насосов. Но они оказались настолько большими, тяжелыми и неудобными для подключения, что в итоге я использовал схему на полевых транзисторах. И в большинстве схем авторы пошли тем-же путём.
- привлекает идея питать всё автономно, от аккумулятора. Но ток в момент старта насоса примерно 360мА, а во время работы 160мА. И это не включая потребления датчиков и самого микроконтроллера, даже если он будет большую часть времени спать. Кроме того, от 3.7В насосы работают совсем не резво. Ставить повышающий преобразователь - получить ещё больше потери емкости. И того, или надо собирать батарею приличной емкости, или не выпендриваться и работать от сети 230В. К стати, а как заряжать аккумуляторы? Бегать к ним с зарядкой? Впрочем один интересный по исполнению проект я нашел и автор утверждает, что он автономен 3 месяца...
- датчик влажности надо брать емкостной, иначе он просто растворится за пару месяцев. Тоже касается и датчика уровня воды. В некоторых проектах применено интересное решение, при котором питание датчиков не постоянно, а только на момент опроса. Это требует дополнительных ног, что немного усложняет проект, тем не менее решение интересное и рабочее. Я же просто использовал емкостной датчик и вообще не ставил датчик уровня воды в баке.
- топить насос или не топить? По правильному - топить. Но я, скептически посмотрев на качество герметизации решил не топить, пусть плавает в полу погруженном состоянии. Просто взял два куска пенопласта и стянул стяжками, а между ними зажались насосы. Шланги должны проходить так, чтобы не образовывались воздушные пробки.
- показания аналоговых датчиков скачет как кардиограмма, что может приводить к неожиданному включению полива или наоборот к не включению. По этому нужен хотя-бы простейший фильтр показаний.
- нет никакого общего правила как будет реагировать земля на полив и сколько надо поливать. В зависимости от грунта влажность может резко подскочить после полива или наоборот медленно подниматься. А у цветов в зависимости от времени года и температуры меняется потребность в воде. Хорошей практикой может быть небольшой полив утром, а в течении дня поддержание влажности на нужном уровне маленькими порциями. Если понадобится. Если влажность начала расти, надо уменьшить порцию утреннего полива.
- застойная вода в открытом сосуде имеет свойство "цвести". Это нормально, в воздухе всегда летают споры одноклеточных водорослей. По этому вся эта конструкция требует или регулярной чистки или должна работать только относительно короткий период отпуска/командировки. Увы. Уменьшить скорость цветения можно закрыв ёмкость с водой от солнца и прикрыв крышкой.
- насосы могут ржаветь или забиваться водорослями или "накипью". Для хранения насосы надо обязательно высушить, а после хранения убедится, что ничего не заклинило и работает.
- оказалось, что насосы, которые я использовал, не герметичны! По этому мой первый вариант который я сделал, где насосы плавают погружаясь в воду только на 2 сантиметра это правильно. С другой стороны, без погружения они быстро перегреваются, что может привести к выходу из строя и короткому замыканию. И того: насосы нельзя полностью погружать и нельзя их запускать более, чем на 15 секунд, после чего обязательно должна быть пауза.

## Особенности работы

Прошивка достаточно гибкая. В файле include/defines.h и include/defines_esp32.h или include/defines_esp32с3.h, в зависимости от используемого микроконтроллера, надо определить какие пины выделить на насосы, какие на датчики влажности, какой тип реле LOW или HIGH применён и сколько Вы хотите ячеек для расписания полива. Всё. Дальше вэб будет отображать именно Ваше количество насосов, датчиков, пунктов расписания. Файлики маленькие и надеюсь достаточно хорошо прокомментированы.
...
Вариант на lolin32-lite:

[![Вариант на lolin32-lite](https://github.com/SerhiiLe/Watering-esp32/blob/main/scheme/Schematic_Watering-esp32.png)](https://github.com/SerhiiLe/Watering-esp32/blob/main/scheme/Schematic_Watering-esp32.pdf)
...
Из особенностей esp32 и esp32c3 могу указать, что в esp32 сенсорную кнопку надо располагать обязательно на adc2, иначе он конфликтует с adc1 на который желательно располагать датчики влажности. Датчики влажности нельзя располагать на adc2, так будет конфликт с wifi. У esp32c3 нет сенсорных входов, нужна обычная механическая кнопка или внешняя сенсорная типа TTP223B. Так-же надо помнить, что ножка GPIO8 в esp32c3 используется и для I2C и для onboard LED.

Вариант на esp32c3supermini:

[![Вариант на esp32c3supermini](https://github.com/SerhiiLe/Watering-esp32/blob/main/scheme/Schematic_Watering-esp32c3.png)](https://github.com/SerhiiLe/Watering-esp32/blob/main/scheme/Schematic_Watering-esp32c3.pdf)

Это конкретно те схемы, по которым я собрал эти две железки. Точнее сначала собрал, а потом нарисовал схему того, что по факту получилось. Естественно, что прошивка как конструктор, можно включать в неё компоненты или убирать. Делать больше насосов или меньше. Можно поставить готовые реле вместо моей схемы ключей на полевых транзисторах. Тут главное идея и возможность её реализовать. В файлах include/defines_* можно всё настроить под себя и прошивка с web адаптируется.
...
Оказалось, что на платах esp32c3 работает только четыре канала ADC (пины 0,1,3,4), пин 2 подтянут к питанию, иначе плата переходит в режим загрузки прошивки при старте, пин 5 относится к другому каналу ADC и используется для калибровки WiFi, как и на esp32, где есть ADC1 и ADC2, второй нельзя использовать при включённом WiFi. Но там это везде описано, а случае с exp32c3 узнаёшь по факту.

В платах esp32 функцию сенсорной кнопки нельзя использовать на одном ADC с аналоговыми датчиками, но можно с WiFi. То есть аналоговые входы это ADC1 (32, 33, 34, 35, 36, 39).

Микросхема 74HC595, сдвиговый регистр, который используется как мультиплексор GPIO, у меня для запуска насосов оказался очень чувствительным и может переключаться при работе насосов. По этому в обвес просто необходимо поставить два конденсатора по 0.1uF, на ножку защёлки 12 пин ST_CP и землёй. И по питанию, между 8 и 16 ножками. Это сильно уменьшает, но не убирает полностью проблему. Как хак я освежаю состояние сдвигового регистра раз в секунду, всегда. Но и это не убирает на 100% проблему.

Ещё одна проблема связанная с 74HC595 - при старте состояние регистров не определено и по этому при включении контроллера одновременно будет включаться часть насосов. Из-за этого будет просадка напряжения и микроконтроллер не запуститься. При работе в автономном режиме и возможного пропадания электричества это недопустимо. Решения два. Первое - поставить электролитический конденсатор на 10uF между пин 10 !MR и землёй, а резистор 10kOhm на питание. Это должно дать обнуление 74HC595 в момент включения. Второй вариант - непосредственно управлять выводом 13 !OE, который отвечает за подключение выводов микросхемы. И этот вывод я соединил с GPIO2 микроконтроллера, который уже подтянут к питанию. В результате управление идёт по 4 проводам, но гарантирует старт.

Имея такие проблемы с 74HC595 могу сказать, что её лучше не использовать, а подключаться непосредственно к выводам микроконтроллера. Использование esp32 вместо esp32c3 добавляет свободные ножки и аналоговых водов много. По габаритам esp32 примерно равна esp32c3 + 74HC595.

Модуль модем SM800L имеет заниженные уровни и вообще нежный. Питать его надо непосредственно от аккумулятора, а для согласования с микроконтроллером нужна целая толпа резисторов.