...
#define USE_AHTx0 // исспользовать датчик температуры и влажности AHT10/AHT20
    ...
    #define PIN_LATCH 7 	// D4 защёлка сдвигового регистра (ST_CP)
    #define PIN_CLOCK 6	    // D2 тактовая сдвигового регистра (SH_CP)
    #define PIN_DATA 10		// D1 данные сдвигового регистра (DS)
#endif
...
const uint8_t sensorPIN[] = {0, 1, 2, 3, 4}; // список PIN к которым подключены датчики влажности. 
...
#define SCHEDULERS 12 // количество ячеек расписания полива
