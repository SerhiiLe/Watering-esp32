...
// #define USE_AHTx0 // исспользовать датчик температуры и влажности AHT10/AHT20
    ...
    #define PIN_OE 19       // (13) подключение к нагрузке (!OE) (можно закомментировать и запаять этот выход на землю. Читай readme)
#endif
...
const uint8_t sensorPIN[] = {35, 34, 33, 39}; // список PIN к которым подключены датчики влажности
...
#define SCHEDULES 8 // количество ячеек расписания полива
